                ...
                <div>
                    ...
                    <Container fluid style={{ marginTop: '3vh' }}>
                        ...
                        <div className="benefits-div">
                            <h2>Benefits</h2>
                            <p>
                                Pahatid Express gives you access to cars 24/7 without the hassle of owning one.
                    ...
                    <div className="find-nearest-car-div">
                        <h2>Find your nearest Pahatid Express</h2>
                        <p>Our cars are spread all over Manila. There's probably one near you</p>
                        <div>
